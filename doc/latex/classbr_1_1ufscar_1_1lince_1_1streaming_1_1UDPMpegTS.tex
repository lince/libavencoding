\hypertarget{classbr_1_1ufscar_1_1lince_1_1streaming_1_1UDPMpegTS}{
\section{br::ufscar::lince::streaming::UDPMpegTS Class Reference}
\label{classbr_1_1ufscar_1_1lince_1_1streaming_1_1UDPMpegTS}\index{br::ufscar::lince::streaming::UDPMpegTS@{br::ufscar::lince::streaming::UDPMpegTS}}
}
...
\index{br::ufscar::lince::streaming::UDPMpegTS@{br::ufscar::lince::streaming::UDPMpegTS}!UDPMpegTS@{UDPMpegTS}}
\index{UDPMpegTS@{UDPMpegTS}!br::ufscar::lince::streaming::UDPMpegTS@{br::ufscar::lince::streaming::UDPMpegTS}}
...
\index{br::ufscar::lince::streaming::UDPMpegTS@{br::ufscar::lince::streaming::UDPMpegTS}!$\sim$UDPMpegTS@{$\sim$UDPMpegTS}}
\index{$\sim$UDPMpegTS@{$\sim$UDPMpegTS}!br::ufscar::lince::streaming::UDPMpegTS@{br::ufscar::lince::streaming::UDPMpegTS}}
\subsubsection[{$\sim$UDPMpegTS}]{\setlength{\rightskip}{0pt plus 5cm}virtual br::ufscar::lince::streaming::UDPMpegTS::$\sim$UDPMpegTS ()\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
...
\index{br::ufscar::lince::streaming::UDPMpegTS@{br::ufscar::lince::streaming::UDPMpegTS}!addStream@{addStream}}
\index{addStream@{addStream}!br::ufscar::lince::streaming::UDPMpegTS@{br::ufscar::lince::streaming::UDPMpegTS}}
\subsubsection[{addStream}]{\setlength{\rightskip}{0pt plus 5cm}void br::ufscar::lince::streaming::UDPMpegTS::addStream ({\bf AVEncoder} $\ast$ {\em stream})\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
...
\index{br::ufscar::lince::streaming::UDPMpegTS@{br::ufscar::lince::streaming::UDPMpegTS}!stop@{stop}}
\index{stop@{stop}!br::ufscar::lince::streaming::UDPMpegTS@{br::ufscar::lince::streaming::UDPMpegTS}}
\subsubsection[{stop}]{\setlength{\rightskip}{0pt plus 5cm}void br::ufscar::lince::streaming::UDPMpegTS::stop ()\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
